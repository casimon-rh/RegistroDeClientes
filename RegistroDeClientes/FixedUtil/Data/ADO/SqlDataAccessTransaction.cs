...
namespace Data.ADO
{
    public class SqlDataAccessTransaction : ISQLDataAcces
    {
        ...
        public SqlDataAccessTransaction()
        {
        ...
        public SqlDataAccessTransaction(IDbConnection conexion)
        {
        ...
        public SqlDataAccessTransaction(DataContext conexion)
        {
