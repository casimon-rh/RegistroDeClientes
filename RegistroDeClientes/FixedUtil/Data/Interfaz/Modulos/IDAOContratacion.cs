...
{
    /// <summary>
    /// Interface de implementación DAO para las operaciones del módulo de Contratación
    /// </summary>
    public interface IDAOContratacion
    {
        /// <summary>
        /// Verifica que no exista una razón social o un RFC repetido de las personas físicas o morales registradas en el sistema
        /// </summary>
        /// <param name="razonSocial">La razon social de la persona física o moral registradas en el sistema</param>
        /// <param name="RFC">El RFC de la persona física o moral registradas en el sistema (Opcional)</param>
        /// <returns>Verdadero si existe un duplicado, falso si no existe</returns>
        bool existeDuplicado(string razonSocial, string RFC = "");
        /// <summary>
        /// Obtiene una lista con todos las personas físicas o morales registradas en el sistema con 
        /// </summary>
        /// <returns></returns>
